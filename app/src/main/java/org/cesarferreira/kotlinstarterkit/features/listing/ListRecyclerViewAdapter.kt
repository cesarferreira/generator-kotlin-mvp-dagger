...
class ListRecyclerViewAdapter(private val items: List<MovieEntity>) : RecyclerView.Adapter<ListRecyclerViewAdapter.ItemViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ItemViewHolder?, position: Int) {
        ...
        (holder as ItemViewHolder).bind(movie.title, movie.genre, movie.id.toString())
    }

    inner class ItemViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        fun bind(title: String, year: String, genre: String) {
